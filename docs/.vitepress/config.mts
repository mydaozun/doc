...
export default defineConfig({
  ...
  themeConfig: {
    ...
    //社交链接
    socialLinks: [
      { icon: 'github', link: 'https://github.com/mydaozun/vitepress-doc' },
    ...
    footer: {
      ...
      copyright: `Copyright © 2023-${new Date().getFullYear()} 备案号：<a href="https://beian.miit.gov.cn/" target="_blank">蜀****号</a>`,
    },
